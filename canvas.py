...
bg_img = tk.PhotoImage(file="./img/background.png")
...
ehtime_label = canvas.create_text((650, 240), text=("Earth Hour:" + eh.strftime("%d-%m-%Y %H:%M:%S")),
                                  font="MSGothic 50 bold", fill="#652828")
